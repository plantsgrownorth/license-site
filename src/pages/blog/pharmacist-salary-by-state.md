...
The federal survey puts the median [pharmacist](/salaries/pharmacists/) salary at $137,480 as of the most current data. Mean is $137,210. That's $66 an hour. The bottom 10% still earn $86,930, which is more than the median salary for [registered nurses](/salaries/registered-nurses/), [police officers](/salaries/police-and-sheriffs-patrol-officers/), and [software developers](/salaries/software-developers/) in a bunch of states. The top 10% clear $172,040.
...
[California](/salaries/california/) is first. Again. $162,110 mean salary. I'm running out of ways to say "California tops the list" across these articles but it keeps happening. Sacramento pharmacists average close to $170K according to weighted data, which is a wild number even by Bay Area standards. [Alaska](/salaries/alaska/) is second at around $152,000, then [Oregon](/salaries/oregon/), [Washington](/salaries/washington/), and [Minnesota](/salaries/minnesota/) rounding out the top five, all above $140K.

Here's something I noticed that's different from the other occupations I've covered: the cost-of-living adjustment actually flips the rankings for pharmacists. After adjustment, [Minnesota](/salaries/minnesota/) comes out on top, not California. Minnesota's cost of living is low enough that a $140K pharmacist salary there buys more than $162K in California. Same thing happened in my police officer article with Alaska; sometimes the not-obvious state is the best financial move.

After the top five you get [New Jersey](/salaries/new-jersey/), [Connecticut](/salaries/connecticut/), [Massachusetts](/salaries/massachusetts/), [New York](/salaries/new-york/), and [Hawaii](/salaries/hawaii/). All above $135K. The floor is high for pharmacists; even middle-of-the-pack states like [Texas](/salaries/texas/) and [Georgia](/salaries/georgia/) pay north of $125K.

## The Lowest-Paying States

[Arkansas](/salaries/arkansas/) is at the bottom, around $98,000 to $115,000 depending on source. Still six figures (barely). [West Virginia](/salaries/west-virginia/), [Mississippi](/salaries/mississippi/), [Alabama](/salaries/alabama/), and [Louisiana](/salaries/louisiana/) are near the floor too.
...
Compare that to a [physician assistant](/salaries/physician-assistants/) at $130K with a master's degree, or a [nurse practitioner](/salaries/nurse-practitioners/) at $132K, also a master's. [Nurse anesthetists](/salaries/nurse-anesthetists/) make $231K but they need a doctorate too, so that's a different conversation. Point is, the PharmD is expensive for what it returns relative to some of these other healthcare paths, and I think prospective students should be honest about that before committing.

## So Is Pharmacy Still Worth It?

I think so, but with a much bigger asterisk than it would've had ten years ago.

If you can get into a hospital, specialty, or clinical setting in a state like [California](/salaries/california/), [Minnesota](/salaries/minnesota/), [Oregon](/salaries/oregon/), or [Washington](/salaries/washington/), the pay is excellent, the work is interesting, and the job security is decent. If you end up behind the counter at a chain in [Mississippi](/salaries/mississippi/) or [Arkansas](/salaries/arkansas/) filling 400 scripts a day with no help, you're going to be miserable and the salary won't feel like it makes up for it.
...
For state-level breakdowns, check our [pharmacist](/salaries/pharmacists/) salary page and [pharmacy technician](/salaries/pharmacy-technicians/) page. If you're comparing healthcare careers, we've got data on [physician assistants](/salaries/physician-assistants/), [nurse practitioners](/salaries/nurse-practitioners/), [nurse anesthetists](/salaries/nurse-anesthetists/), [registered nurses](/salaries/registered-nurses/), and [dental hygienists](/salaries/dental-hygienists/). State hubs for [California](/salaries/california/), [Texas](/salaries/texas/), [New York](/salaries/new-york/), and [Minnesota](/salaries/minnesota/) have the full picture.
